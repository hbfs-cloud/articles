...
where region like '${d.region_select.value}'`,H=`select
    ...
    round(avg(change_pct), 2) as avg_change
from market.stocks
where region like '${d.region_select.value}'`;i.region_summary_data&&(i.region_summary_data instanceof Error?q.initialError=i.region_summary_data:q.initialData=i.region_summary_data,i.region_summary_columns&&(q.knownColumns=i.region_summary_columns));let I,N=!1;const F=Ve.createReactive({callback:S=>{a(0,I=S)},execFn:p},{id:"region_summary",...q});F(H,{noResolve:c,...q}),globalThis[Symbol.for("region_summary")]={get value(){return I}};let U={initialData:void 0,initialError:void 0},_=oe`select
    country,
    count(*) as nb_stocks,
    sum(market_cap) as total_mcap,
...
where region like '${d.region_select.value}'
order by market_cap desc
limit 20`;i.region_top_stocks_data&&(i.region_top_stocks_data instanceof Error?_e.initialError=i.region_top_stocks_data:_e.initialData=i.region_top_stocks_data,i.region_top_stocks_columns&&(_e.knownColumns=i.region_top_stocks_columns));let be,Z=!1;const Le=Ve.createReactive({callback:S=>{a(4,be=S)},execFn:p},{id:"region_top_stocks",..._e});Le(W,{noResolve:ne,..._e}),globalThis[Symbol.for("region_top_stocks")]={get value(){return be}};let se={initialData:void 0,initialError:void 0},K=oe`select
    symbol,
    name,
    price,
    change_pct,
...
where region like '${d.region_select.value}'
order by market_cap desc
limit 20`),m.$$.dirty[0]&503316480&&(ne||!Z?ne||(Le(W,{noResolve:ne,..._e}),a(28,Z=!0)):Le(W,{noResolve:ne})),m.$$.dirty[0]&256&&a(30,K=oe`select
    symbol,
    name,
    price,
    change_pct,
...
from market.stocks
where region like '${d.region_select.value}'
order by market_cap desc`),m.$$.dirty[0]&1610612736|m.$$.dirty[1]&3&&(K||!Ie?K||(ve($e,{noResolve:K,...se}),a(32,Ie=!0)):ve($e,{noResolve:K}))},[I,$,te,ie,be,h,l,i,d,q,c,H,N,U,_,E,A,ee,X,ue,de,ae,x,fe,ke,_e,ne,W,Z,se,K,$e,Ie,t]}class Ar extends zt{constructor(r){super(),Yt(this,r,kr,dr,Nt,{data:6},null,[-1,-1])}}export{Ar as component};
