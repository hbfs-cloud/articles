...
${(() => {
  ...
  ${totalActions > 0 ? `<table class="t">
    <thead><tr><th>Ticker</th><th>Score</th><th class="hide-m">Strat.</th><th>Entry</th><th class="hide-m">Stop</th><th>TP1</th><th>TP2</th><th class="hide-m">R/R</th><th class="hide-m">Alloc</th><th>Action</th></tr></thead>
  ...
  ${watchRows.length ? `<details${totalActions > 0 ? '' : ' open'}>
    ...
    <table class="t" style="margin-top:.5rem">
      <thead><tr><th>Ticker</th><th>Score</th><th class="hide-m">Strat.</th><th>Entry</th><th class="hide-m">Stop</th><th>TP1</th><th>TP2</th><th class="hide-m">R/R</th><th>Status</th></tr></thead>
