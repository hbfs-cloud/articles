...
<div class="section-card" data-static="1">
  <details>
    ...
    <div class="method-steps" style="margin-top:.85rem">
      ...
      <div class="step"><span class="step-n" style="background:${cfg.color}">3</span><div>Once in the trade, set your <b>stop loss</b> at −${cfg.maxStopPct}% from your entry and your <b>take profit</b> at TP1.</div></div>` : `
