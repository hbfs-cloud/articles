...
const formats={amount:{format:'fr',scale:1,decimals:3},eur:{format:'fr',scale:1,decimals:2,suffix:' €'},pct:{format:'fr',scale:100,decimals:2,suffix:' %',sign:'always'},freq:{format:'fr',scale:100,decimals:1,suffix:' %'},int:{format:'fr',scale:1,decimals:0},decimal:{format:'fr',scale:1,decimals:2},date:{format:'fr_date',parts:'weekday_day_month'},tax:{format:'fr',scale:100,decimals:2,suffix:' %'}};
