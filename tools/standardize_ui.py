    ...
    for d in DIRS:
        for root, _, files in os.walk(d):
            if 'index.html' in files and 'archive' not in root.split(os.sep):
                ...
                new_link = '<img src="https://market-watch.xyz/logo.svg" alt="MW" style="height:28px;"> MARKET WATCH'
                ...
                new_title = '<img src="https://market-watch.xyz/logo.svg" alt="MW" style="height:28px;"> MARKET WATCH\n        </a>'
            ...
            <p>&copy; 2026 Market Watch &mdash; Intelligence Institutionnelle</p>
