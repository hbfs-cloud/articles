...
const eventRows = [
  ...
  [
    "Mardi",
    "Inflation zone euro · ISM industrie · DELL, PANW, MDB, CRDO après clôture",
  ...
  [
    "Jeudi",
    "Inscriptions au chômage, ISM services, Fed · CIEN avant, ZS après",
...
mount('eventChart',{tooltip:{trigger:'axis'},grid:{left:35,right:18,top:20,bottom:38},xAxis:{type:'category',data:['Lun.','Mar.','Mer.','Jeu.','Ven.']},yAxis:{type:'value',min:0,max:5,show:false},series:[{type:'bar',barMaxWidth:52,data:[{value:1,itemStyle:{color:'#94a3b8'}},{value:4,itemStyle:{color:'#64748b'}},{value:5,itemStyle:{color:'#2563eb'}},{value:4,itemStyle:{color:'#0f766e'}},{value:5,itemStyle:{color:'#d97706'}}],label:{show:true,position:'top',formatter:p=>['Préparation','Macro + 4','AVGO + 2','Macro + 2','Emploi'][p.dataIndex]}}]});
