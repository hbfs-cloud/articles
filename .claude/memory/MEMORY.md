...
- [Editorial Voice — No AI](feedback_editorial_voice.md) — Règle #1 rédaction tout le site : concis, direct, actionnable, JAMAIS style IA (bannir signposting/tics ; garder chiffres réels ; Substack/Telegram = niveau enfant 10 ans). Contrôle : `tools/check-ai-tells.js`.
