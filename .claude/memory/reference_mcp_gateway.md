...
description: "OBSOLÈTE — MCP_GATEWAY_URL remplacé par OAuth2 depuis 2026-06-20. Voir [[project-cloud-routine-automerge]]"
metadata: 
  node_type: memory
  type: reference
...
Voir [[project-cloud-routine-automerge]] pour le nouveau modèle.
