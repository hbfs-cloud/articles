...
for (const slide of slides) {
  ...
  if (slide.type === 'title') {
    chapters.push('00:00 Introduction');
  }
...
// Delete old video
try { await youtube.videos.delete({ id: '67x59wfTu3M' }); console.log('🗑️ Deleted old video'); } catch(e) { console.log('Old video not found'); }
