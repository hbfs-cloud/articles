  ...
  function initSidebar() {
    ...
    var T = {
      fr: {
        ...
        "sidebar.start": "D\u00e9buter en Bourse",
      },
      en: {
        "tab.radar": "Radar",
        "tab.weekly": "Weekly",
      ...
      es: {
        ...
        "tab.weekly": "Semanal",
        "tab.daily": "Diario",
        "tab.analyses": "An\u00e1lisis",
        "tab.scanner": "Esc\u00e1ner",
        "tab.series": "Series",
        "tab.tech": "Tech",
        "search.trigger": "Buscar...",
        "sidebar.start": "Empezar",
      },
      zh: {
        "tab.radar": "\u96f7\u8fbe",
        "tab.weekly": "\u5468\u62a5",
    ...
    var html = [
      ...
      '    <a href="/?search=1" class="sidebar-search-btn"><i class="fa-solid fa-magnifying-glass"></i><span data-i18n="search.trigger">' +
        t("search.trigger") +
        "</span><kbd>\u2318K</kbd></a>",
    ...
    // ECharts initialises before this asynchronous desktop rail changes the
    // available width. Wait for layout, then let every chart resize to its host.
    ...
    // === Fetch tab counts ===
    ["weekly", "daily", "analyses", "scanner", "series", "tech"].forEach(
      function (tab) {
