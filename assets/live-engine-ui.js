...
(function () {
  ...
  css.textContent = [
    ...
    '  .w{max-width:1520px!important;padding:0 2rem 1rem!important}',
    '  .hero{padding:.4rem 1.5rem .3rem!important}',
    '  .hero h1{font-size:1.1rem!important;margin-bottom:.1rem!important}',
    '  .hero p{font-size:.7rem!important;margin:0!important}',
    '  .hero-meta{margin-top:.15rem!important;font-size:.6rem!important}',
    '  .breadcrumb{padding:.15rem 1.5rem!important;font-size:.58rem!important}',
    '  .mode-tabs{margin-bottom:.4rem!important;padding:.15rem!important}',
    '  .mode-tab{padding:.35rem .7rem!important;font-size:.72rem!important}',
    '  .brand-bar{padding:.3rem 1.5rem!important}',
    '}',
    ...
    /* Hide "How to trade" on desktop — static info, saves vertical space */
    '  .lp-grid>[data-grid="method"]{display:none!important}',
    /* Compact equity in grid */
    '  .lp-grid .perf-hero{padding:.5rem .7rem!important;gap:.5rem!important;flex-direction:column!important}',
    '  .lp-grid .perf-chart{min-height:110px!important;height:110px!important}',
    '  .lp-grid .perf-head{margin-bottom:.2rem!important}',
    '  .lp-grid .perf-head h2{font-size:.8rem!important}',
    '  .lp-grid .perf-stats{grid-template-columns:repeat(3,1fr)!important;min-width:0!important;gap:.25rem!important}',
    '  .lp-grid .ps{padding:.2rem .2rem!important}',
    '  .lp-grid .ps-v{font-size:.85rem!important}',
    '  .lp-grid .ps-l{font-size:.46rem!important}',
    /* Compact section cards in grid */
    '  .lp-grid .section-card{padding:.5rem .7rem!important;margin-bottom:0!important}',
    '  .lp-grid .sc-head{margin-bottom:.3rem!important}',
    '  .lp-grid .sc-head h3{font-size:.78rem!important}',
    '  .lp-grid .t th,.lp-grid .t td{padding:.25rem .4rem!important;font-size:.68rem!important}',
    '  .lp-grid .scenario-bar-wrap{margin-bottom:.4rem!important;padding:.4rem .6rem!important}',
    '  .lp-grid .cta-card{padding:.5rem .7rem!important;margin-bottom:0!important}',
    '  .lp-grid .disc{margin-top:.3rem!important;padding:.4rem!important;font-size:.55rem!important}',
    /* Compact community/related sections */
    '  .lp-grid .community-section,.lp-grid .related-section{display:none!important}',
    '}',
    ...
    '.lp-strip{display:flex;align-items:center;gap:0;padding:0;position:relative;min-height:36px}',
