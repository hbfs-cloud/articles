...
(function () {
  ...
  css.textContent = [
    ...
    /* "How to trade" — visible, collapsed <details> handles space */
    '  .lp-grid>[data-grid="method"]{grid-column:1/-1;grid-row:auto;margin-bottom:.5rem}',
    ...
    '  box-shadow:0 2px 6px rgba(15,23,42,.05),0 8px 24px rgba(15,23,42,.04);',
    '}',
    ...
    '.lp-conn-chip.connected{color:var(--pos,#059669);background:var(--pos-wk,#ecfdf5)}',
    '.lp-conn-chip.connecting{color:var(--warn-ink,#d97706);background:var(--warn-wk,#fffbeb)}',
    '.lp-conn-chip.disconnected{color:var(--neg,#dc2626);background:var(--neg-wk,#fef2f2)}',
    '.lp-conn-chip.idle{color:var(--muted,#94a3b8);background:var(--surface-2,#f1f5f9)}',
    ...
    '}',
    '@media(prefers-reduced-motion:reduce){.lp-pnl{transition:none}}',
    '.lp-pnl.pos{color:var(--pos,#059669);font-weight:800}',
    '.lp-pnl.neg{color:var(--neg,#dc2626);font-weight:800}',
    '.lp-pnl.flat{color:var(--flat,#94a3b8)}',
    /* Colorblind-safe leading glyph (sign+weight+color already present) */
    '.lp-pnl.pos::before{content:"\\25b2 ";font-size:.55em;vertical-align:.12em}',
    '.lp-pnl.neg::before{content:"\\25bc ";font-size:.55em;vertical-align:.12em}',
    '.lp-pnl.flat::before{content:"\\2013 ";font-size:.55em}',
    '.lp-pnl-sub{font-size:.6rem;color:var(--muted,#94a3b8);font-weight:600;text-transform:uppercase;letter-spacing:.07em;margin-top:.25rem}',

    /* Chips row */
    '.lp-strip-chips{display:flex;align-items:center;gap:.5rem;padding:.5rem .9rem;flex-wrap:wrap;flex:1}',
    '.lp-chip{display:inline-flex;align-items:center;gap:.3rem;font-size:.68rem;font-weight:700;padding:.22rem .55rem;border-radius:6px;white-space:nowrap}',
    '.lp-chip-pos{background:var(--surface-2,#f1f5f9);color:var(--ink-2,#334155);border:1px solid var(--border,#e2e8f0)}',
    '.lp-chip-alert-crit{background:var(--neg-wk,#fef2f2);color:var(--neg,#dc2626)}',
    '.lp-chip-alert-warn{background:var(--warn-wk,#fffbeb);color:var(--warn-ink,#b45309)}',
    ...
    '.lp-market-chip.open{color:var(--pos,#059669);background:var(--pos-wk,#ecfdf5)}',
    '.lp-market-chip.closed{color:var(--muted,#64748b);background:var(--surface-2,#f1f5f9)}',
    ...
    '.lp-ticker-sym{font-size:.82rem;font-weight:800;color:var(--ink,#0f172a);letter-spacing:.02em;line-height:1}',
    ...
    '.lp-change.pos{color:var(--pos,#059669)}',
    '.lp-change.neg{color:var(--neg,#dc2626);font-weight:700}',
    '.lp-change.flat{color:var(--flat,#94a3b8)}',
    '.lp-change.pos::before{content:"\\25b2 ";font-size:.85em}',
    '.lp-change.neg::before{content:"\\25bc ";font-size:.85em}',

    '.lp-pnl-cell{display:flex;align-items:center}',
    ".lp-pnl-val{font-family:var(--mono,'JetBrains Mono',monospace);font-size:.78rem;font-weight:700;font-variant-numeric:tabular-nums}",
    '.lp-pnl-val.pos{color:var(--pos,#059669)}',
    '.lp-pnl-val.neg{color:var(--neg,#dc2626);font-weight:800}',
    '.lp-pnl-val.flat{color:var(--flat,#94a3b8)}',
    '.lp-pnl-val.pos::before{content:"\\25b2 ";font-size:.82em}',
    '.lp-pnl-val.neg::before{content:"\\25bc ";font-size:.82em}',
    ...
    '  .lp-grid>[data-grid-empty="1"]{display:none!important}',
    '  .lp-grid>[data-grid="method"]{margin-bottom:.3rem}',
