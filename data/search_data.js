window.searchDataPrebuilt = [
  ...
  },
  {
    ...
    "exchange": "",
    "name": "",
    "title": "Top 10 A+ RISK-ON — GS, JPM, MSFT, COP, NOC, ASML, SAP, TSM, XLF, XLI",
    "desc": "Regime: RISK-ON (score 0.50) — VIX sub-20 (3rd session), SPX 6,886.24 (+1.02%), Dow positive YTD. Oil $104 WTI (energy tailwind). DXY ~98.5 (continued dollar weakness). 10Y yield 4.38% (slight rise on Iran/oil inflation fears). The regime holds RISK-ON with caveats: energy and defense are the clear ...",
    "tags": "us,eu,asia,tech,semis,financials,energy,defense,etf,ai,macro,technique,trade-idea",
    "grade": "",
