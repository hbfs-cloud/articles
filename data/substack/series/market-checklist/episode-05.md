---
title: "Precommit the Loss Rules"
subtitle: "Stops, event checks, and drawdown limits work only when decided in advance."
module_id: "market-checklist"
episode_number: 5
source_path: "series/marketwatch-checklist/part5-risk/index.html"
---
...
Event risk is the calendar. List every scheduled company and macro event inside the holding window, and choose in advance for each one: exit, cut, hedge, or accept a specific overnight loss you have already priced. A volatility-compression setup carried through an earnings date once gapped 18% against me overnight. There was no intermediate exit. The compression released, just not in the direction the chart suggested.

Portfolio risk is the account. Mine is mechanical. Three stops in a row, no new trades for 24 hours, because the decisions that follow a losing streak are the worst ones you will make all month. Down 5% in a week, position size halves. Down 10% in a month, everything stops until the strategy has been reviewed properly. Those thresholds should never force selling into a market that is not there.

Two micro-caps from a 10 March 2026 scan fell 13.2% and 8.7% while the tape was risk-off. Both had clean technical setups. Neither had a floor, because the buyers had left the segment entirely.
