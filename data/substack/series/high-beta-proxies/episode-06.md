...
Now fill that skeleton in: twelve real positions across seven sectors, 7% left in cash. The same book prints 1.18, not 1.30. Nothing about the strategy changed — only which names landed in which sleeve, and how much cash sat idle. The number is an output of composition, not a property of the plan.
