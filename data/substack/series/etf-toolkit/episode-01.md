...
- Check what it legally is: a registered fund, an ETN, a commodity pool, something else.
- Read the objective and how the index is actually built.
- Look at the holdings, the top-ten weight and whether it holds the assets or a swap.
- Check the expense ratio, the typical spread and the history of premiums or discounts.
- Compare fund and index returns over identical dates, in the same currency.
- Read the terms covering creation, redemption, closure and liquidation.
