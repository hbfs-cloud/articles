---
title: "Separate the Policy Rate From Its Operating Tools"
subtitle: "The announced target, implementation settings, and market response are distinct facts."
module_id: "central-bank-playbook"
episode_number: 2
source_path: "series/banques-centrales/part2-taux-directeurs/index.html"
---
...
The ECB publishes three key rates, not one, and mid-2026 they sat at 2.75% for the deposit facility, 2.90% for the main refinancing operations, and 3.15% for the marginal lending facility. Each does a different job — overnight deposits, weekly collateralised lending, emergency overnight credit. A note that says "the ECB rate" has thrown away the information.
...
The nominal target is also not the whole stance. Balance-sheet policy, lending facilities, collateral terms and forward guidance can all pull at once.

**Limitation:** implementation frameworks get rebuilt, and the same 25 basis points can land in completely different economies. Prices move on positioning, liquidity, unrelated news and other lines in the same statement. A clean decomposition improves the record; it does not identify one cause.

Sources: [New York Fed: Monetary Policy Implementation](https://www.newyorkfed.org/markets/domestic-market-operations/monetary-policy-implementation); [Federal Reserve: Open Market Operations](https://www.federalreserve.gov/monetarypolicy/openmarket.htm); [ECB: Key Interest Rates](https://www.ecb.europa.eu/stats/policy_and_exchange_rates/key_ecb_interest_rates/html/index.en.html)
