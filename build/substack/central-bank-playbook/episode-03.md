---
title: "Read QE and QT Through the Balance Sheet"
subtitle: "Track purchases, maturities, reinvestment, holdings, and reserves as separate quantities."
module_id: "central-bank-playbook"
episode_number: 3
source_path: "series/banques-centrales/part3-qe-qt/index.html"
---
*Part 3 of 6 in The Central Bank Playbook.*

::audience non_sub,free_sub
Each part stands on its own. This is 3 of 6 in The Central Bank Playbook; earlier parts cover the groundwork but you can start here.
::end
...
Watch how that plays out in real caps. The Fed's tightening ran at $47.5bn a month from June 2022 ($30bn Treasuries, $17.5bn mortgage bonds), doubled to $95bn from September 2022 ($60bn and $35bn), then slowed to about $60bn from mid-2024 with the Treasury cap cut to $25bn. Those are ceilings, not deliveries. The mortgage cap stayed at $35bn while actual runoff came in nearer $15bn, because few mortgage bonds happened to mature. <mark>Announced pace and realised change are two different series.</mark> Check both.

![Monthly runoff caps, in two parts](https://raw.githubusercontent.com/hbfs-cloud/articles/main/substack-assets/examples/central-bank-playbook_episode-03.png)

Before writing anything about a balance-sheet announcement, do this.

1. Save the announcement with its release time and time zone.
1. Pull out the eligible assets, the pace, the caps and the effective period.
1. Keep gross purchases, redemptions, reinvestment and net change in separate columns.
1. Compare the announced flow against the holdings actually published afterwards.
1. Look at the liabilities rather than leaning on one word like "liquidity".
1. Record the rate decision separately from the balance-sheet decision.
...
> A pace is not a stock, and a cap is not a delivery.
