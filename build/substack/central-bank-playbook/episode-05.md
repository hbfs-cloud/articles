---
title: "Read Inflation and Jobs Data at the Series Level"
subtitle: "Publisher, reference period, adjustment, revisions, and policy relevance come before the headline."
module_id: "central-bank-playbook"
episode_number: 5
source_path: "series/banques-centrales/part5-indicateurs-cles/index.html"
---
*Part 5 of 6 in The Central Bank Playbook.*

::audience non_sub,free_sub
Each part stands on its own. This is 5 of 6 in The Central Bank Playbook; earlier parts cover the groundwork but you can start here.
::end

Housing is about 36% of the Consumer Price Index and about 16% of the personal consumption expenditures price index. One number, two answers, and that weighting gap alone explains most of the reason CPI usually prints 0.2 to 0.3 points higher than PCE. "Inflation" is not a data point. <mark>It is a choice of series, and the choice changes the answer.</mark>
...
### How to work a macro release

1. Take the event time and time zone from the BLS or BEA schedule, not a news calendar.
1. Save the official release and its technical note at publication.
1. Record the series name, seasonal status, reference period and change interval.
1. Preserve the first vintage before later revisions overwrite it.
1. Source any consensus separately, with its own pre-release timestamp.
1. Log market prices only inside a window you declared beforehand.
...
> Name the series before you argue about the number.
