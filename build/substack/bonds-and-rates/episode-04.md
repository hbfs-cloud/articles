---
title: "A Credit Spread Is More Than Default Risk"
subtitle: "Benchmark choice, maturity, liquidity and bond terms all sit inside the extra yield."
module_id: "bonds-and-rates"
episode_number: 4
source_path: "series/obligations-et-taux/part4-credit-spreads/index.html"
---
*Part 4 of 6 in Bonds and Rates for Equity Traders.*

::audience non_sub,free_sub
Each part stands on its own. This is 4 of 6 in Bonds and Rates for Equity Traders; earlier parts cover the groundwork but you can start here.
::end
...
1. Name the bond, its seniority and the benchmark.
1. Match maturity or duration as closely as the data allow.
1. State the spread convention supplied by the data source.
1. Check calls, collateral and recent trade activity.
1. Compare with issuer peers and the broader credit index.
