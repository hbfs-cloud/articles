...
Futures and retail foreign exchange bring contract-specific sessions and heavy leverage. On 15 January 2015 the Swiss National Bank abandoned its 1.20 floor without warning; EUR/CHF went from 1.2010 to about 0.8500 in seconds, near −30%. At 100:1 leverage a $10,000 position implies a $300,000 loss. One broker failed, another was left with $225 million of client debit balances, and industry-wide margin calls ran past $1 billion. Digital assets trade around the clock, but continuous timestamps do not mean continuous liquidity: CME bitcoin futures close Friday evening and reopen Sunday, and the spot market keeps moving in between. The weekend gap on the futures contract is a recurring feature, not an occasional accident — check the contract specification for the exact halt, and measure the gap distribution yourself before you size around it.
