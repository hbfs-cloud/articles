...
That is the whole subject. <mark>Size an overnight position as though its stop may fill at the next available price, not at the trigger.</mark>
...
1. Name the price you are measuring the gap from.
1. Verify the news through the issuer, a regulator, or an official release.
1. Read your broker's stop and session rules — not the ones you assume.
1. Stress the position at an adverse executable price and record the result.

> A stop is an instruction to leave, not a promise about the price you leave at.
