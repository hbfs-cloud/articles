---
title: "Trace the Economic Transmission Chain"
subtitle: "Separate reference exposure from operating leverage and company risk"
module_id: "high-beta-proxies"
episode_number: 4
source_path: "series/proxys-haut-beta/part4-secteurs-leaders/index.html"
---
*Part 4 of 6 in Use High-Beta Proxies Without Getting Trapped.*

::audience non_sub,free_sub
Each part stands on its own. This is 4 of 6 in Use High-Beta Proxies Without Getting Trapped; earlier parts cover the groundwork but you can start here.
::end
...
Note what the arithmetic does not do. It says nothing about the share price. Costs rise. Output slips. Hedges cap the price the company actually receives. Investors decide the business deserves a smaller multiple. <mark>The chain explains the amplification; it does not predict the return.</mark>
...
> Walk the chain out loud before you rank anything: a miner is not metal, and a chip supplier is not an index.
