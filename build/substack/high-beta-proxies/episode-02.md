...
Each part stands on its own. This is 2 of 6 in Use High-Beta Proxies Without Getting Trapped; earlier parts cover the groundwork but you can start here.
::end
...
1. State the exact reference and what you want the position to express.
1. Align adjusted prices, currency, timestamps and return frequency.
1. Record beta, correlation, R-squared, overlap and residual volatility.
1. Recompute over a shorter window to test whether the number holds still.
1. Read the prospectus or the filings before ranking anything.
1. Reject a candidate whose mechanics fight your holding period.

> A daily promise held for a year is not the same promise.
