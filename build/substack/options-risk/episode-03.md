...
Each part stands on its own. This is 3 of 6 in Options Without the Hidden Risk; earlier parts cover the groundwork but you can start here.
::end

<mark>Every one of these trades is a promise about shares, wearing a premium as a disguise.</mark> Decide whether you accept the share outcome first. The premium is the last thing to look at, not the first.
...
1. Write the exact share obligation triggered if the short leg is assigned.
1. Work out the effective purchase or sale price after the premium.
1. Show the stock loss at zero, next to the option profit, on the same page.
1. Check earnings dates, dividend dates and early-assignment exposure.
1. Decide now whether each leg gets closed, exercised, or left to expire.
...
> Accept the share outcome first. The premium is what you are paid for accepting it, never a reason to accept it.
