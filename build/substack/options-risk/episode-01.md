...
<mark>Being right on direction and still losing everything is ordinary here.</mark>
...
1. Confirm the underlying, strike, expiration, multiplier and what gets delivered.
1. Note whether it can be exercised early or only at expiry, and whether it settles in shares or cash.
1. Turn the quoted premium into dollars: quote times 100 times contracts.
1. Write out the right you bought, or the obligation you sold, in one plain sentence.
1. Work out the breakeven and the worst outcome the contract permits.
...
> Read the five fields before you read the view: the contract sets the payoff, and no opinion overrides it.
