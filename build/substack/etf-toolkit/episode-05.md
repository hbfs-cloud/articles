...
Each part stands on its own. This is 5 of 6 in The ETF Toolkit; earlier parts cover the groundwork but you can start here.
::end
...
![The same two days, told twice](https://raw.githubusercontent.com/hbfs-cloud/articles/main/substack-assets/examples/etf-toolkit_episode-05.png)

Nothing malfunctioned. The fund delivered three times each daily move. <mark>Resetting the leverage every evening simply means day two's multiplier applies to a different base than day one's.</mark> In a smooth trend that helps you. In a chop it grinds you down.
...
1. Write down the exact benchmark, the multiple and the reset period.
1. Recreate one trending path and one alternating path by hand, on paper.
1. Read the derivatives, financing and counterparty disclosures.
1. Set the holding horizon and the exit rule before entry, not after.
1. Test a gap open, a wide spread and a day the fund misses its daily objective.
1. If options are involved, calculate the combined exposure and the worst obligation.
