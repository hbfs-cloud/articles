...
- Reconcile rows against broker statements.
- Lock the formulas and date every definition change.
- Show exclusions, blanks, and sample size beside each number.
- Trace any summary figure back to the trades under it.
- Approve one change, written in advance, with a stop condition.
